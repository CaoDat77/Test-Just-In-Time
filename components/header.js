...
function Header({ props, data }) {
  ...
  return (
    <header className="bg-white  gap-5  flex h-[70px] xl:static fixed top-0 w-full z-[5]">
      <div className="xl:w-[20%] w-full flex-shrink-0 flex items-center px-5 py-3 justify-center relative">
        <svg
        ...
        <div
          ...
          className={`absolute top-1/2 ${show === true ? "bg-[#e0f3ff]" :""} left-5 -translate-y-1/2 hover:bg-[#e0f3ff] w-10 h-10 flex items-center justify-center rounded`}
        >
          {show === false ? (
            <svg
              xmlns="http://www.w3.org/2000/svg"
      ...
      <section
        className={`fixed w-[80%] h-[100vh] overflow-auto bg-white top-[73px] boxShadow px-3 py-3 menu z-[2] ${
          show === true ? "menuMobileShow" : ""
        }`}
      >
